...
if ($_SERVER["REQUEST_METHOD"] === "GET" && isset($_GET['id'])) {
    ...
    $sql = "UPDATE users SET first_name = ?, last_name = ?, username = ?, password = ?, email = ?, image = ? WHERE user_id = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssssi", $first_name, $last_name, $username,$password, $email, $image_path, $user_id);
