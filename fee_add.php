        	...
        	<div class="container">
			 ...
			 <form method="POST" enctype="multipart/form-data">
					...
					<br>
						...
						<div class="field">
							...
							<div class="input-field">
								...
								<input type="text" name="amount_from"  required>
							</div>

							<div class="input-field">
								<label>Amount To</label>
								<input type="text" name="amount_to"  required>
							</div>

							<div class="input-field">
								<label>Percent</label>
								<input type="text" name="fee_percentage"  required>
							</div>
						</div>
				...
				<div class="btn">
								...
								<br>
								<button style="padding: 10px ; border-radius: 5px; width: 150px; color: white; background-color: gray; margin-top:20px"  name=""  required ><a href="fee.php" style="color:white">Cancel</a> </button>
							</div>
					</div>
				</div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO fee_structure (amount_from, amount_to, fee_percentage)
            VALUES (?, ?, ?)";
    
    $stmt = $conn->prepare($sql);

    if ($stmt) {
        $stmt->bind_param("ddd", $amount_from, $amount_to, $fee_percentage);
        $stmt->execute();
