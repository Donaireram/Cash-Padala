...
$sql = "SELECT id, amount_from,amount_to, fee_percentage, date_created FROM fee_structure ";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <td ><?php echo $row["amount_from"] ?></td>
        <td ><?php echo $row["amount_to"] ?></td>
        ...
        <td ><?php echo $row["date_created"] ?></td>
         ...
         <?php
                ...
                $selectOptions .= '<option value="fee_update.php?id=' . $row["id"] . '">Edit</option>';
                $selectOptions .= '<option value="d1.php?id=' . $row["id"] . '">Delete</option>';
