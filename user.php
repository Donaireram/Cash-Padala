    ...
    <div class="body">
        <nav class="side-bar">
            ...
            <ul>
                ...
                <li><a href="list.php"><i class="fas fa-table-list"></i> <span>Transaction List</span></a></li>
                <li><a href="report.php"><i class="fas fa-file"></i> <span>Reports</span></a></li>
                <li><a href="income.php"><i class="fas fa-money-bill"></i> <span>Income</span></a></li>
                <li><a href="user.php"><i class="fas fa-user"></i> <span>User List</span></a></li>
                <li><a href="fee.php"><i class="fas fa-table"></i> <span>Fee List</span></a></li>
                <li><a href="branch.php"><i class="fas fa-code-branch"></i> <span>Branch List</span></a></li>
                <li><a href="archive1.php"><i class="fas fa-trash-can-arrow-up"></i> <span>Archive</span></a></li>
                ...
                <section class="table__body">
                    <table id="data-table">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT u.user_id, u.image, u.first_name, u.username, u.role FROM users u";
                            ...
                            if ($result && $result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>" . $row["role"] . "</td>";
                                    echo "<td><select class='hiddenSelect'><option value='#'>Action</option><option value='user_update.php?id=" . $row["user_id"] . "'>Edit</option><option value='d1.php?id=" . $row["user_id"] . "'>Delete</option></select></td>";
                                    echo "</tr>";
                                }
                            } else {
    ...
    <script>
        document.querySelectorAll('.hiddenSelect').forEach(select => {
            select.addEventListener('change', function() {
                ...
                if (selectedValue !== '#') {
                    window.location = selectedValue; // Redirect to selected action
                }
            });
        });
    </script>
