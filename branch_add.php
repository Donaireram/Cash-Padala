...
<?php
include 'connect.php'; // Assuming you've included the database connection

if ($_SERVER["REQUEST_METHOD"] === "POST") {
    $branch_name = $_POST["branch_name"];
    $address = $_POST["address"];

    // Insert the new branch information into the database
    $sql = "INSERT INTO branches (branch_name, address) VALUES (?, ?)";
