    ...
    <div class="header_fixed">
        <table id="data-table">
            <thead>
                ...
                <tbody>
<?php
$sql = "SELECT transaction_id, created_at, tracking_code, amount, status FROM archive";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <tr >
                ...
                $selectOptions .= '<option value="restore.php?id=' . $row["transaction_id"] . '">restore</option>';
                $selectOptions .= '<option value="delete.php?id=' . $row["transaction_id"] . '">Delete</option>';
