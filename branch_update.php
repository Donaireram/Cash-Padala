...
if ($_SERVER["REQUEST_METHOD"] === "GET" && isset($_GET['id'])) {
    ...
    // Fetch branch data based on the provided ID
    ...
    // Handle the form submission for updating branch details
    $branch_id = $_POST["branch_id"];
    $branch_name = $_POST["branch_name"];
    $address = $_POST["address"];

    // Update the branch information in the database
    $sql = "UPDATE branches SET branch_name = ?, address = ? WHERE branch_id = ?";
    $stmt = $conn->prepare($sql);
            ...
            <div class="container">
             ...
             <input type="hidden" name="branch_id" value="<?php echo $branch_id; ?>">
                ...
                <div class="btn">
                                ...
                                <br>
                                <input style="padding: 10px ; border-radius: 5px; width: 150px; color: white; background-color: green; scroll-margin-bottom: 50px; " type="submit" name="submit" value="Update" required></input>

                                <div class="btn" style="margin-left: 200px; margin-top: -76px">

                                <br>
                                <button style="padding: 10px ; border-radius: 5px; width: 150px; color: white; background-color: gray; margin-top:20px"  name=""  required ><a href="branch.php" style="color:white">Cancel</a> </button>
                            </div>
                        </div>
                    </div>
                        </div>
